...
const enUS: MessageSchema = {
    ...
    tunnels: {
        ...
        connectionsSearchPlaceholder: 'Search by address…',
        connectionsSearchClear: 'Clear search',
        connectionsEmpty: 'No active connections',
        connectionsSearchEmpty: 'No connections match "{q}"',
        connectionRemoteAddr: 'Remote',
        connectionLocalAddr: 'Local',
        connectionConnectedAt: 'Connected at',
        connectionTrafficIn: 'In',
        connectionTrafficOut: 'Out',
    },
    traffic: {
        in: 'Inbound',
        out: 'Outbound',
